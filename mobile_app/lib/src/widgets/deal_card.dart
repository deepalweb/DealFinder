              ...
              children: [
                ...
                if (p.discountedPrice != null || p.originalPrice != null || p.price != null)
                  Row(
                    ...
                    children: [
                      Text(
                        '$_currencySymbol${(p.discountedPrice ?? p.price ?? p.originalPrice)!.toStringAsFixed(0)}',
                      ...
                      if (p.originalPrice != null && p.discountedPrice != null) ...[
                        ...
                        Text(
                          '$_currencySymbol${p.originalPrice!.toStringAsFixed(0)}',
                  ...
                  Row(
                    children: [
                      if (p.originalPrice != null) ...[
                        Text('$_currencySymbol${p.originalPrice!.toStringAsFixed(2)}',
                            style: const TextStyle(decoration: TextDecoration.lineThrough, color: Colors.grey, fontSize: 13)),
                        const SizedBox(width: 8),
                      ],
                      Text('$_currencySymbol${(p.discountedPrice ?? p.price)!.toStringAsFixed(2)}',
