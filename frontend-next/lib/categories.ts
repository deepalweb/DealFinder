...
export const DEALFINDER_CATEGORIES: DealFinderCategory[] = [
  ...
  { id: 'food_bev', name: 'Food & Cafes', icon: 'fa-utensils' },
  { id: 'travel', name: 'Travel', icon: 'fa-plane' },
  { id: 'beauty_health', name: 'Beauty & Salon', icon: 'fa-heart-pulse' },
  { id: 'home_garden', name: 'Groceries & Essentials', icon: 'fa-house' },
  { id: 'entertainment', name: 'Entertainment', icon: 'fa-gamepad' },
  { id: 'services', name: 'Repairs & Services', icon: 'fa-screwdriver-wrench' },
  { id: 'pets', name: 'Pets', icon: 'fa-paw' },
  { id: 'education', name: 'Pharmacy & Wellness', icon: 'fa-school' },
